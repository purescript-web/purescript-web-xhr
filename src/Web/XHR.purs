...
import Web.XHR.Types (ReadyState(..), ResponseType, XHR, XMLHttpRequest, XMLHttpRequestUpload, blob, document, string, xmlHttpRequestToEventTarget, xmlHttpRequestUploadToEventTarget)
